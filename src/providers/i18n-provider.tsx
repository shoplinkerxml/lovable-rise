...
const dictionary: Dictionary = {
  ...
  company_placeholder: { uk: "Введіть назву компанії", en: "Enter company name" },
  store_url: { uk: "URL магазину", en: "Store URL" },
  store_url_placeholder: { uk: "https://myshop.ua", en: "https://myshop.ua" },
...
const toastDictionary = {
  ...
  no_categories_found: { uk: "Категорії не знайдені", en: "No categories found" },
