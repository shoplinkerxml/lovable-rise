...
-- Migration to add missing menu items (tariff, reports, settings) for all existing users
-- Also updates the default menu creation function for new users

-- Add tariff menu item for all existing users
...
-- Add reports menu item for all existing users
-- INSERT INTO public.user_menu_items (
--   user_id, 
--   title, 
--   path, 
...
-- Add settings menu item for all existing users
-- INSERT INTO public.user_menu_items (
--   user_id, 
--   title, 
--   path, 
